...
char *test_exists()
{
    ...
    assert(cllist_length(list) == 4, "List length must be 4");
    assert(cllist_exists(list, "zero", cmp_func) == true, "zero should exist in the list");
    assert(cllist_exists(list, "one", cmp_func) == true, "one should exist in the list");
    assert(cllist_exists(list, "two", cmp_func) == true, "two should exist in the list");
    assert(cllist_exists(list, "three", cmp_func) == true, "three should exist in the list");
    assert(cllist_exists(list, "foo", cmp_func) == false, "foo shouldn't exist in the list");
    assert(cllist_length(list) == 4, "List length must be 4");
    cllist_destroy(list);
